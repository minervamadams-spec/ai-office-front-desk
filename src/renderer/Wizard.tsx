...
import type { ConnectorManifest, ConnectorState, DeskProfile, GoogleState, OutlookState } from '../shared/contracts';
...
export function Wizard({ profile, catalog, jira, google, outlook, onUpdateProfile, onUpdateDesign, onFinish, onDismissNotice }: {
  profile: DeskProfile;
  ...
  return <main className="wizard">
    ...
    <section className="wizard-panel">
      ...
      {step === 2 && <>
        ...
        <ServiceCatalogGrid catalog={catalog} jira={jira} google={google} outlook={outlook} dismissedNotices={profile.dismissedNotices} onDismissNotice={onDismissNotice} showSearch={false}/>
