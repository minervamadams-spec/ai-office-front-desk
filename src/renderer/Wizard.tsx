...
import type { ConnectorManifest, ConnectorState, DeskProfile, GoogleState, OutlookState, GitHubState, SlackState, TeamsState } from '../shared/contracts';
...
export function Wizard({ profile, catalog, jira, google, outlook, github, slack, teams, onUpdateProfile, onUpdateDesign, onFinish, onDismissNotice }: {
  profile: DeskProfile;
  ...
  return <main className="wizard">
    ...
    <section className="wizard-panel">
      ...
      {step === 2 && <>
        ...
        <ServiceCatalogGrid catalog={catalog} jira={jira} google={google} outlook={outlook} github={github} slack={slack} teams={teams} dismissedNotices={profile.dismissedNotices} onDismissNotice={onDismissNotice} showSearch={false}/>
