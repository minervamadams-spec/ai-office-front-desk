...
export const connectorCatalog: ConnectorManifest[] = [
  ...
  { id: 'slack', name: 'Slack', status: 'available', summary: 'Recent message previews from the channels you list — public or private, once the bot is invited.', auth: 'Installer-supplied Bot User OAuth Token from a Slack app you create in your own workspace', reads: 'Channel name, message author, a short text preview, and a link — from the channels you specify', permissions: ['channels:history', 'channels:read', 'groups:history', 'groups:read'], adminApproval: false, apiToken: true, setupTime: '10–15 minutes', officialSetupUrl: 'https://api.slack.com/authentication/basics', retention: 'Only selected fields; disconnect clears the cache.' },
